...
(setq text-blocks--filename-007 "tests/data/text-blocks-test-007")
...
(setq text-blocks--test-metadata
      '((test-id 02 data-file-id 001 position 001 expect 'not-vertical-gap)
        ...
        (test-id 05 data-file-id 001 position 007 expect 'not-vertical-gap)
        (test-id 06 data-file-id 001 position 008 expect 'not-vertical-gap)
        ...
        (test-id 11 data-file-id 001 position 021 expect 'not-vertical-gap)
        (test-id 12 data-file-id 001 position 022 expect 'not-vertical-gap)
        ...
        (test-id 21 data-file-id 004 position 024 expect 'not-vertical-gap)
        (test-id 22 data-file-id 004 position 025 expect 'not-vertical-gap)
        (test-id 23 data-file-id 004 position 026 expect 'not-vertical-gap)
        ...
        (test-id 27 data-file-id 004 position 043 expect 'not-vertical-gap)
        (test-id 28 data-file-id 004 position 233 expect 'not-vertical-gap)
        (test-id 29 data-file-id 004 position 234 expect 'not-vertical-gap)
        ...
        (test-id 33 data-file-id 004 position 269 expect 'not-vertical-gap)
        (test-id 34 data-file-id 004 position 302 expect 'not-vertical-gap)
        (test-id 35 data-file-id 004 position 316 expect 'not-vertical-gap)
        (test-id 36 data-file-id 004 position 322 expect 'not-vertical-gap)
        (test-id 37 data-file-id 004 position 410 expect 'not-vertical-gap)
        (test-id 38 data-file-id 004 position 292 expect 'not-vertical-gap)
        (test-id 39 data-file-id 007 position 024 expect 'vertical-gap)
        (test-id 40 data-file-id 007 position 025 expect 'not-vertical-gap)
        (test-id 41 data-file-id 007 position 045 expect 'not-vertical-gap)
        (test-id 42 data-file-id 007 position 104 expect 'vertical-gap)
        (test-id 43 data-file-id 007 position 100 expect 'not-vertical-gap)
        (test-id 44 data-file-id 007 position 124 expect 'not-vertical-gap)
        (test-id 45 data-file-id 007 position 187 expect 'vertical-gap)
        (test-id 46 data-file-id 007 position 270 expect 'not-vertical-gap)
...
(if (file-exists-p text-blocks--filename-007)
  ...
  (error "File '%s' does not exist" text-blocks--filename-007))
...
(provide 'text-blocks--vertical-gap-p-04)
