...
(setq text-blocks--test-metadata
      '((test-id 03 data-file-id 001 expect 003)
        (test-id 04 data-file-id 002 expect 007)
        (test-id 05 data-file-id 003 expect 002)
        (test-id 06 data-file-id 004 expect 011)
        (test-id 07 data-file-id 005 expect 020)
        (test-id 08 data-file-id 006 expect 024)))
