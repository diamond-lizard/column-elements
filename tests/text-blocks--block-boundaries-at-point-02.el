...
(setq text-blocks--test-metadata
      '((test-id 01 data-file-id 001 position 000 side 'left expect 0)
        ...
        (test-id 32 data-file-id 004 position 025 side 'top expect nil)
        ...
        (test-id 42 data-file-id 004 position 025 side 'bottom expect nil)
        ...
        (test-id 52 data-file-id 004 position 302 side 'left expect nil)
        (test-id 53 data-file-id 004 position 302 side 'right expect nil)
        ))
...
(provide 'text-blocks--block-boundaries-at-point-02)
