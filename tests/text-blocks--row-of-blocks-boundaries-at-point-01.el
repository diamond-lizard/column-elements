...
(setq text-blocks--test-metadata
      '((test-id 01 data-file-id 001    position 000 side 'left   expect 0)
        ...
        (test-id 24 data-file-id 002    position 000 side 'right  expect 81)
        (test-id 25 data-file-id 002    position 019 side 'right  expect 81)
        (test-id 26 data-file-id 002    position 265 side 'right  expect 81)
        (test-id 27 data-file-id 002    position 180 side 'right  expect 81)
        (test-id 28 data-file-id 002    position 394 side 'right  expect 81)
        (test-id 29 data-file-id 002    position 403 side 'right  expect 81)
