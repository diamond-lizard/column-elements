...
(setq text-blocks--filename-008 "tests/data/text-blocks-test-008")
...
(setq text-blocks--test-metadata
      '((test-id 02 data-file-id 008 position 024 expect 'vertical-gap)
        (test-id 03 data-file-id 008 position 025 expect 'not-vertical-gap)
        (test-id 04 data-file-id 008 position 045 expect 'not-vertical-gap)
        (test-id 05 data-file-id 008 position 104 expect 'vertical-gap)
        (test-id 06 data-file-id 008 position 100 expect 'not-vertical-gap)
        (test-id 07 data-file-id 008 position 124 expect 'not-vertical-gap)
        (test-id 08 data-file-id 008 position 187 expect 'vertical-gap)
        (test-id 09 data-file-id 008 position 270 expect 'not-vertical-gap)
        (test-id 10 data-file-id 008 position 272 expect 'not-vertical-gap)
        (test-id 11 data-file-id 008 position 354 expect 'not-vertical-gap)
        (test-id 12 data-file-id 008 position 375 expect 'vertical-gap)
        (test-id 13 data-file-id 008 position 457 expect 'vertical-gap)
        ))
...
;; Read in test file 008, if it exists.
(if (file-exists-p text-blocks--filename-008)
    (setq text-blocks--original-data-008
          (find-file-read-only text-blocks--filename-008))
  (error "File '%s' does not exist" text-blocks--filename-008))
...
(provide 'text-blocks--vertical-gap-p-05)
